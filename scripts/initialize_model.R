...
# Initialize_Model.R
# Initializes the reservoir simulation model and creates necessary output files
# Sets up initial reservoir volumes and clears output directories for new simulations
