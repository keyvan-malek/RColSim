...
# PMFs.R (Performance Measures and Functions)
# Defines performance metrics and utility functions for reservoir operations evaluation
# Includes functions for energy production, flood control, fish flow targets, and navigation
