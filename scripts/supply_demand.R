# Supply_Demand.R
# Processes water supply and demand data for reservoir simulation
# Calculates instream flows, curtailments, and water allocations across the Columbia River Basin
...
get_iflow <- function(time_series, station) {
	ifile <- read.table(paste0('inputs/iflow_rules/', station, '_iflow_rules'))
