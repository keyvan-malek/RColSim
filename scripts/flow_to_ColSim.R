# Flow_To_ColSim.R
# Processes climate and flow data to prepare inputs for the RColSim reservoir model
# Converts supply/demand data, calculates refill curves, and generates simulation input files
...
## Agricultural water demand is simulated with the VIC-CropSyst model. The irrigation demands are aggregated from the grid scale to drainage areas using the file "inputs/miscellaneous/pod_update_RColSim.txt", which links each grid cell to 
## its drainage.
